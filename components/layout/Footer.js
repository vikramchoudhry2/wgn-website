        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="flex space-x-6">
              {/* Instagram */}
              <a 
                href="https://www.instagram.com/wegotnextacademy" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-pink-500 transition-colors duration-300 group"
              >
              ...
              {/* TikTok */}
              <a 
                href="https://www.tiktok.com/@wegotnextacademy" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-black hover:bg-white rounded transition-all duration-300 group"
              >
                <div className="flex flex-col items-center space-y-1">
                  <svg className="w-6 h-6 group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* YouTube */}
              {/*<a 
                href="https://www.youtube.com/@wegotnextacademy" 
                target="_blank" 
                rel="noopener noreferrer"
             ...
             {/* 
              <a 
                href="https://twitter.com/wegotnextacademy" 
                target="_blank" 
                rel="noopener noreferrer"
