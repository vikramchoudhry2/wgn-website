            ...
            >
              <div className="relative w-full h-80 overflow-hidden rounded-t-2xl">
                <img
                  ...
                  style={{ objectPosition: `center ${card.posY ?? 50}%` }}
                  draggable={false}
                />
              </div>
