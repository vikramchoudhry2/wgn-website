      ...
      <section className="bg-gradient-to-br from-black via-gray-950 to-slate-900 text-white py-20 relative overflow-hidden">
        ...
        <div className="container-center relative z-10">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            className="text-center mt-20 bg-gradient-to-br from-blue-500/10 to-purple-500/10 backdrop-blur-sm rounded-3xl p-12 border border-blue-500/20"
          >
            <motion.h2
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              Want to be part of the We Got Next family? Join our community events, camps, and programs and help us build something amazing together!
            </motion.p>
            ...
            >
              {!emailSubmitted ? (
                <form onSubmit={handleEmailSubmit} className="w-full max-w-md">
                  <div className="flex flex-col sm:flex-row gap-4">
                    <motion.input
                      ...
                      required
                      className="flex-1 px-6 py-4 rounded-full bg-white/10 backdrop-blur-sm border border-white/30 text-white placeholder-gray-300 focus:outline-none focus:border-blue-500 focus:bg-white/20 transition-all duration-300"
                    />
                    <motion.button
                      type="submit"
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-8 py-4 rounded-full font-bold text-lg hover:shadow-2xl transition-all duration-300 flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {isSubmitting ? (
                        <>
                ...
                <motion.div
                  initial={{ opacity: 0, scale: 0.8 }}
                  animate={{ opacity: 1, scale: 1 }}
                  className="text-center bg-gradient-to-r from-green-500/20 to-blue-500/20 backdrop-blur-sm rounded-2xl p-6 border border-green-500/30"
                >
                  ...
                  <p className="text-gray-300">Thanks for joining our community. We'll keep you updated on all the latest events and news!</p>
                </motion.div>
              )}
            </motion.div>
          </motion.div>
